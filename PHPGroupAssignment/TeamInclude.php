...

{
        ...
        $pos = strpos ($file, $pText, 1);
        if (strpos ($file, $pText))
        {
            echo "<p> string $pText was found at position $pos </p>";
        }
        else
...

{
        ...
        $filename = 'editor.dat';
        $file = file_get_contents($filename);
        $pos = stripos ($file, $pText, 1);
        if (stripos ($file, $pText))
        {
            echo "<p> string $pText was found at position $pos </p>";
        }
        else
...
{
        echo "<p>";
        displayTextArea("f_Area","area",5,40,$value);
        echo"</p>
